...
/// Renders a winking expression (left eye open, right eye closed).
void renderWinkEyes(
  SvgBuilder svg, {
  ...
  // Left pupil
  svg.addCircle(cx: 338.51, cy: 559.08, r: 12.24, fill: theme.outline);
  ...
  // Right eye lower detail
  svg.addPath(
    'M627,574.16a114.14,114.14,0,0,1,13.07-1.56c4.36-.3,8.72-.43,13.08-.44s8.71.14,13.07.43a114.34,114.34,0,0,1,13.08,1.57,112.18,112.18,0,0,1-13.08,1.58q-6.54.43-13.07.42t-13.08-.43A112,112,0,0,1,627,574.16Z',
    fill: theme.outline,
  );

  // Lashes (only left for wink)
  if (withLashes) {
    renderLeftLash(svg, theme: theme);
  }
}
