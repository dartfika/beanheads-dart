...
/// Renders squinting eyes with partially closed lids.
void renderSquintEyes(
  SvgBuilder svg, {
  ...
  // Upper lid
  svg.addPath(
    'M339.2,490.12a68.31,68.31,0,0,0-48.45,20.07,69.79,69.79,0,0,0-6.86,8,73.12,73.12,0,0,0-10.3,18.39H403.92a58.59,58.59,0,0,0-20.12-30,69.37,69.37,0,0,0-6.28-4.79A68.21,68.21,0,0,0,339.2,490.12Z',
    fill: skinBase,
  ...
  // Lower lid
  svg.addPath(
    'M274.09,581.45c5.5,13.75,15.3,25.93,27.92,33.32a68.27,68.27,0,0,0,10.15,4.7c24.63,9.09,55,5.07,74.49-11.61a69.9,69.9,0,0,0,7.29-7.61,55.62,55.62,0,0,0,4.6-6.42,77.37,77.37,0,0,0,4.94-12.38Z',
    fill: skinBase,
    stroke: theme.outline,
    strokeMiterlimit: 10,
    strokeWidth: '8px',
  ...
  // Lower lid
  svg.addPath(
    'M594.1,581.87c5.51,13.76,15.3,25.94,27.92,33.32a68.79,68.79,0,0,0,10.15,4.71c24.63,9.09,55,5.06,74.49-11.62a68.91,68.91,0,0,0,7.29-7.6,56.5,56.5,0,0,0,4.6-6.42,76.19,76.19,0,0,0,4.94-12.39Z',
    fill: skinBase,
    stroke: theme.outline,
    strokeMiterlimit: 10,
    strokeWidth: '8px',
  ...
  if (withLashes) {
    ...
    renderRightLash(svg, theme: theme);
  }
}
