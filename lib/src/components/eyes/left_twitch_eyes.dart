...
/// Renders eyes with the left eye twitching (partially closed).
void renderLeftTwitchEyes(
  SvgBuilder svg, {
  ...
  // Pupil (raised)
  svg.addCircle(cx: 338.51, cy: 541.79, r: 12.24, fill: theme.outline);
  // Twitch lid
  svg.addPath(
    'M399.52,583a59.6,59.6,0,0,0,4.18-8.82,62.5,62.5,0,0,0,2.57-8.64c-68.32-7.75-127,20.81-127,20.81l1.1,1.75c.41.62.82,1.24,1.25,1.84a68.28,68.28,0,0,0,6.11,7.48c22.06,20.36,59.06,24.36,86.44,11.39a68.37,68.37,0,0,0,7.85-5,63.08,63.08,0,0,0,7.12-6.07,64.78,64.78,0,0,0,5.68-7A63.85,63.85,0,0,0,399.52,583Z',
    fill: skinBase,
